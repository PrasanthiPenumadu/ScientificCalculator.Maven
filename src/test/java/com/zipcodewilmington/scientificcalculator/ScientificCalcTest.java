...
public class ScientificCalcTest {
    ...
    public void mathOperation() {
        ...
        assertEquals("1", calc.MathOperation("sin",90));
        assertEquals(".99", calc.MathOperation("sin",1.5));
        ...
        assertEquals("34.75",calc.MathOperation("inverse sine",.57));
        assertEquals("38.99",calc.MathOperation("inverse sine",.6293));
        assertEquals("33.6",calc.MathOperation("inverse cosine",.833));
        assertEquals("45",calc.MathOperation("inverse tan",1));
        assertEquals("36.86",calc.MathOperation("inverse tan",.75));
